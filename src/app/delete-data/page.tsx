...
export default function DeleteDataPage() {
	...
	return (<div className="min-h-screen bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
					...
					<div className="text-gray-300 max-w-3xl mx-auto">
						<div className="mb-8 bg-gray-700 p-6 rounded-lg">
							<p className="mb-4 text-lg">
								Conformément au Règlement Général sur la Protection des Données (RGPD), vous avez le droit de demander
								la suppression de vos données personnelles. Cette page vous explique comment exercer ce droit.
							</p>
						</div>
						
						<div className="mb-8 bg-gray-700 p-6 rounded-lg">
							<h2 className="text-2xl font-semibold mb-6 text-blue-400">Comment demander la suppression de vos données
								?</h2>
							<p className="mb-6 text-lg">
								Pour demander la suppression de vos données personnelles, veuillez nous envoyer un email à
								l&apos;adresse suivante :
							</p>
							...
							<ul className="list-disc pl-6 mb-6 space-y-3 text-lg">
								...
								<li className="text-gray-300">La mention <span className="font-mono bg-gray-800 px-2 py-1 rounded">Demande de suppression de données personnelles</span> dans
									l&apos;objet du message
								</li>
							</ul>
						</div>
						...
						<div className="mb-8 bg-gray-700 p-6 rounded-lg">
							...
							<p className="mb-4 text-lg">
								Nous nous engageons à traiter votre demande dans un délai maximum de 30 jours à compter de sa réception.
						...
						<div className="mb-8 bg-gray-700 p-6 rounded-lg">
							...
							<ul className="list-disc pl-6 mb-4 space-y-3 text-lg">
								...
								<li className="text-gray-300">Les données nécessaires à la constatation, l&apos;exercice ou la défense
									de droits en justice
								</li>
								<li className="text-gray-300">Les données nécessaires au respect d&apos;obligations légales ou
									réglementaires
								</li>
							</ul>
						</div>
						...
						<div className="bg-gray-800 p-8 rounded-lg border border-gray-600">
							...
							<p className="text-lg">
								Pour toute question concernant la protection de vos données, n&#39;hésitez pas à nous contacter à
								l&#39;adresse{' '}
								<a
									href="mailto:joelbeya.bj@outlook.com"
