...
export default function PrivacyPage() {
	...
	return (<div className="bg-gray-800 text-gray-300 py-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
		...
		<div className="prose prose-invert max-w-none">
			<div className="mb-8">
				<p className="mb-4">
					Chez Monanga Business, nous prenons la protection de vos données personnelles très au sérieux. Cette
					politique de confidentialité vous explique quelles données nous collectons, comment nous les utilisons et
			...
			<div className="mb-8">
				...
				<p>
					Le responsable du traitement des données est la société Monanga Business, immatriculée au registre du
					commerce de Kinshasa sous le numéro [NUMERO_RCCM], dont le siège social est situé au 123 Avenue de la Paix,
					Gombe, Kinshasa, RDC.
				</p>
			</div>
			...
			<div className="mb-8">
				...
				<ul className="list-disc pl-6 mb-4 space-y-2">
					...
					<li>Données de paiement : informations de carte bancaire (gérées par nos prestataires de paiement
						sécurisés)
					</li>
			...
			<div className="mb-8">
				...
				<p>
					Nous nous assurons que tous nos partenaires respectent des exigences strictes en matière de protection des
					données.
				</p>
			</div>
			...
			<div className="mb-8">
				...
				<p>
					Certains de nos prestataires sont situés en dehors de l&apos;Union Européenne. Dans ce cas, nous mettons en
					place les garanties appropriées pour assurer un niveau de protection adéquat de vos données, notamment par
			...
			<div className="mb-8">
				...
				<p>
					Vous pouvez gérer vos préférences en matière de cookies via les paramètres de votre navigateur ou via notre
			...
			<div className="mb-8">
				...
				<p className="mb-4">
					...
					contre tout accès non autorisé, altération, divulgation ou destruction. Parmi ces mesures :
				</p>
				<ul className="list-disc pl-6 mb-4 space-y-2">
			...
			<div className="mb-8">
				...
				<p className="mb-4">
					Pour exercer ces droits, vous pouvez nous contacter à l&apos;adresse : dpo@monangabusiness.com ou par
					courrier à l&apos;adresse du siège social en joignant une copie de votre pièce d&apos;identité.
				</p>
				<p>
					Vous avez également le droit d&apos;introduire une réclamation auprès de l&apos;autorité de contrôle
					compétente si vous estimez que le traitement de vos données n&apos;est pas conforme à la réglementation.
				</p>
			</div>
			
			<div className="mb-8">
				<h2 className="text-2xl font-semibold mb-4 text-blue-400">11. Mises à jour de la politique de
					confidentialité</h2>
				<p>
					Nous nous réservons le droit de modifier la présente politique de confidentialité à tout moment. Toute mise
					à jour sera publiée sur cette page avec une mention de la date de dernière mise à jour. Nous vous
			...
			<div className="mb-8">
				...
				<p className="mb-2">Pour toute question concernant la présente politique de confidentialité ou pour exercer
					vos droits, vous pouvez nous contacter :</p>
				<ul className="list-disc pl-6 mb-4 space-y-2">
