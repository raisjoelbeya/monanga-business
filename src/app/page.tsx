...
const SocialIcon = ({href, icon, label, colorClass}: {
	href: string; icon: React.ReactNode; label: string; colorClass: string;
}) => (<a
		href={href}
...
const Footer = () => (<footer className="bg-gray-800 text-gray-300 py-10">
						...
						<FeatureCard
							...
							icon={<svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24"
								...
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
								      d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
							</svg>}
						/>
						<FeatureCard
			...
			<section className="py-16 bg-gray-900">
				<div className="max-w-6xl mx-auto px-6">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
						...
						>
							Je suis très satisfait des produits que j&apos;ai reçus. La qualité est exceptionnelle et les délais de
							livraison sont respectés. Un service irréprochable !
						</TestimonialCard>
						...
						>
							Livraison ultra-rapide et produits de qualité supérieure. Je recommande vivement Monanga Business pour son
						...
						>
							Service client réactif et à l&apos;écoute. Les produits correspondent parfaitement à la description. Je ne
							vais plus ailleurs pour mes achats en ligne !
						</TestimonialCard>
					</div>
				</div>
			</section>
					...
					<div className="flex justify-center gap-6 mb-8">
						<SocialIcon
							...
							icon={<svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
								<path
									d="M12 2C6.477 2 2 6.477 2 12v4c0 1.103.897 2 2 2h2.177C6.812 20.252 9.855 21 12 21c2.145 0 5.188-.748 7.823-2H22c1.103 0 2-.897 2-2v-4c0-5.523-4.477-10-10-10zM12 9c2.757 0 5 2.243 5 5s-2.243 5-5 5-5-2.243-5-5 2.243-5 5-5z"/>
							</svg>}
						/>
						<SocialIcon
							href="#"
